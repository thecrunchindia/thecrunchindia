...
const PrivacyModal = ({ isOpen, onClose }) => {
  ...
  const handleClose = () => {
    if (window.history.state?.privacyModalOpen) {
      window.history.back();
    }
    onClose();
  };
        ...
        <div className="fixed inset-0 z-[3000] flex items-end md:items-center justify-center p-0 md:p-6 overflow-hidden outline-none">
          ...
          >
            ...
            <div className="flex justify-between items-center p-6 md:p-8 border-b border-gray-100 shrink-0 bg-white">
              <h2 className="text-lg md:text-2xl font-black uppercase tracking-tighter text-slate-900 mt-2 md:mt-0">Privacy Policy</h2>
            ...
            <div className="flex-1 overflow-y-auto p-6 md:p-8 text-gray-600 space-y-6 md:space-y-8">
              <section>
                <h3 className="text-sm md:text-base font-black text-slate-900 uppercase tracking-widest mb-3">1. Information Collection</h3>
                <p className="text-xs md:text-sm leading-relaxed font-medium text-justify">We collect information from you when you register on our site, place an order, subscribe to our newsletter, or fill out a form. This includes your name, email address, mailing address, and phone number.</p>
              </section>
              <section>
                <h3 className="text-sm md:text-base font-black text-slate-900 uppercase tracking-widest mb-3">2. Use of Information</h3>
                <p className="text-xs md:text-sm leading-relaxed font-medium text-justify">Any of the information we collect from you may be used to personalize your experience, improve our website, improve customer service, and process transactions. Your information will not be sold without your consent.</p>
              </section>
              <section>
                <h3 className="text-sm md:text-base font-black text-slate-900 uppercase tracking-widest mb-3">3. Data Security</h3>
                <p className="text-xs md:text-sm leading-relaxed font-medium text-justify">We implement a variety of security measures to maintain the safety of your personal information when you place an order or enter, submit, or access your personal information.</p>
              </section>
